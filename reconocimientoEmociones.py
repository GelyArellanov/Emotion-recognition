#Source: https://omes-va.com/reconocimiento-de-emociones-opencv-python/
...
while True:
	...
	for (x,y,w,h) in faces:
		...
		if method == 'EigenFaces':
			if result[1] < 5700:
				cv2.putText(frame,'{}'.format(imagePaths[result[0]]),(x,y-25),2,1.1,(255,203,219),1,cv2.LINE_AA)
				cv2.rectangle(frame, (x,y),(x+w,y+h),(255,203,219),2)
